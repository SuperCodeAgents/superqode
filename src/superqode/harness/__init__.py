...
_LAZY_IMPORTS = {
    ...
    "TauHarnessBackend": (".backends", "TauHarnessBackend"),
    "TauHarnessProtocolAdapter": (
        ".tau_adapter",
        "TauHarnessProtocolAdapter",
    ),
    "RLMCodeSettings": (".backends", "RLMCodeSettings"),
    ...
    "HarnessBenchManifest": (".bench", "HarnessBenchManifest"),
    "build_harness_bench_scorecard": (".bench", "build_harness_bench_scorecard"),
    "load_harness_bench_manifest": (".bench", "load_harness_bench_manifest"),
    "render_harness_bench_scorecard": (".bench", "render_harness_bench_scorecard"),
    "run_harness_bench": (".bench", "run_harness_bench"),
    "verify_harness_bench": (".bench", "verify_harness_bench"),
    "activate_harness_promotion": (".promotion", "activate_harness_promotion"),
    "harness_promotion_state": (".promotion", "harness_promotion_state"),
    "read_promotion_registry": (".promotion", "read_promotion_registry"),
    "rollback_harness_promotion": (".promotion", "rollback_harness_promotion"),
    "select_harness_promotion": (".promotion", "select_harness_promotion"),
    "stage_harness_promotion": (".promotion", "stage_harness_promotion"),
    "start_harness_canary": (".promotion", "start_harness_canary"),
    ...
    "HarnessOmniOptimizationResult": (".omni", "HarnessOmniOptimizationResult"),
    "optimize_harness_with_omni": (".omni", "optimize_harness_with_omni"),
    "render_harness_omni_result": (".omni", "render_harness_omni_result"),
...
__all__ = [
    ...
    "optimize_harness_with_omni",
    "render_harness_omni_result",
    "DEFAULT_LOGBOOK_DIR",
