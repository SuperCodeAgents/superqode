...
PROVIDERS: Dict[str, ProviderDef] = {
    ...
    "moonshot": ProviderDef(
        ...
        notes="Kimi K3 via Moonshot's first-party OpenAI-compatible global API. 1M context, native tools and vision, always-on max reasoning.",
        dynamic=True,
    ),
    ...
    "opencode": ProviderDef(
        ...
        example_models=[],
        free_models=[],
        notes="OpenCode model catalog is discovered dynamically via `opencode models --verbose`.",
    ),
