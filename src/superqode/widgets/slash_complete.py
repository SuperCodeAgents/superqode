...
DEFAULT_COMMANDS: list[SlashCommand] = [
    ...
    SlashCommand(":agents doctor", "Check agent readiness", category="agents"),
    ...
    SlashCommand(":harness runs", "List persisted harness runs", category="workflow"),
    SlashCommand(":harness validate", "Validate a HarnessSpec", category="workflow"),
    SlashCommand(":harness explain", "Explain a HarnessSpec", category="workflow"),
    SlashCommand(":harness diff", "Diff two HarnessSpecs", category="workflow"),
    SlashCommand(":harness run", "Run a HarnessSpec task", category="workflow"),
    SlashCommand(":harness test", "Run HarnessSpec checks", category="workflow"),
    SlashCommand(":harness eval", "Run HarnessSpec eval tasks", category="workflow"),
    SlashCommand(":harness auto-bench", "Benchmark harness candidates", category="workflow"),
    ...
    SlashCommand(":runtime doctor", "Check runtime backend readiness", category="workflow"),
    SlashCommand(":auth", "Inspect provider and agent authentication", category="workflow"),
    SlashCommand(":auth check", "Check provider or agent auth", category="workflow"),
    SlashCommand(":config", "Show or validate SuperQode config", category="workflow"),
    ...
    SlashCommand(
        ":chat",
        "Local/BYOK direct model chat without repo context or tools",
        category="workflow",
    ),
    SlashCommand(":chat on", "Enable Local/BYOK direct model chat", category="workflow"),
    SlashCommand(":chat off", "Return from chat to normal prompts", category="workflow"),
    SlashCommand(":build", "Use the repo-aware coding harness", category="workflow"),
    SlashCommand(":mode", "Pick Chat, Build, or Plan mode", category="workflow"),
    SlashCommand(":mode chat", "Switch to Local/BYOK direct model chat", category="workflow"),
    SlashCommand(":mode build", "Switch to the coding harness", category="workflow"),
    SlashCommand(":mode plan", "Switch to planning before edits", category="workflow"),
    SlashCommand(":providers doctor", "Diagnose provider setup", category="workflow"),
    SlashCommand(":providers smoke", "Run provider smoke checks", category="workflow"),
    SlashCommand(":providers models", "List provider models", category="workflow"),
    SlashCommand(":models", "Browse the model catalog", category="workflow"),
    SlashCommand(":models download", "Download a model artifact", category="workflow"),
    SlashCommand(":models cached", "List cached local model artifacts", category="workflow"),
    SlashCommand(":local init", "Generate a local-first harness", category="workflow"),
    SlashCommand(":local smoke", "Run local model smoke checks", category="workflow"),
    SlashCommand(":local servers", "Show local model server status", category="workflow"),
    SlashCommand(":local stop", "Stop a managed local model server", category="workflow"),
    ...
    SlashCommand(":switchboard switch", "Switch active session by id", category="workflow"),
    SlashCommand(":switchboard info", "Show session graph metadata", category="workflow"),
    ...
    SlashCommand(":trust", "Show project trust status", category="workflow"),
    SlashCommand(":trust yes", "Trust this project on this machine", category="workflow"),
    SlashCommand(":trust no", "Mark this project untrusted", category="workflow"),
    SlashCommand(":trust doctor", "Show trust-sensitive project files", category="workflow"),
    ...
    SlashCommand(":sidebar", "Toggle the sidebar", category="workflow"),
    SlashCommand(":sodebar", "Alias for :sidebar", category="workflow"),
    ...
    SlashCommand(":plugins doctor", "Validate local plugin manifests", category="workflow"),
    SlashCommand(":plugins add", "Install a local plugin package", category="workflow"),
    SlashCommand(":plugins enable", "Enable a plugin id", category="workflow"),
    SlashCommand(":plugins disable", "Disable a plugin id", category="workflow"),
    SlashCommand(":memory", "Show agent memory status", category="workflow"),
    SlashCommand(":memory providers", "List memory providers", category="workflow"),
    SlashCommand(":memory doctor", "Check memory provider readiness", category="workflow"),
    SlashCommand(":memory remember", "Store an explicit local memory", category="workflow"),
    SlashCommand(":memory search", "Search agent memory", category="workflow"),
    SlashCommand(":memory forget", "Delete a local memory", category="workflow"),
    SlashCommand(":memory export", "Export memory JSON", category="workflow"),
    SlashCommand(":local", "Local Agentic Coding stack doctor", category="workflow"),
    SlashCommand(":local doctor", "Recommend engine + model for this machine", category="workflow"),
    ...
    SlashCommand(":skills optimize", "Run GEPA skill optimization", category="workflow"),
    SlashCommand(":skillopt export", "Export a SkillOpt workspace", category="workflow"),
    SlashCommand(":skillopt check", "Check a staged skill candidate", category="workflow"),
    ...
    SlashCommand(":vim", "Show optional Vim mode status and commands", category="system"),
    SlashCommand(":vim on", "Enable optional Vim mode", category="system"),
    SlashCommand(":vim off", "Disable optional Vim mode", category="system"),
    SlashCommand(":set vim", "Enable optional Vim mode", category="system"),
    SlashCommand(":set novim", "Disable optional Vim mode", category="system"),
    SlashCommand(":w", "Export the current transcript", category="system"),
