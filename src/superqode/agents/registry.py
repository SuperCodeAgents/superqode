...
AGENTS: Dict[str, AgentDef] = {
    ...
    "kimi": AgentDef(
        ...
        protocol=AgentProtocol.ACP,
        status=AgentStatus.SUPPORTED,
        description="Moonshot AI's first-party coding agent",
        auth_info="Launch `kimi` and complete `/login`",
        setup_command="curl -fsSL https://code.kimi.com/kimi-code/install.sh | bash",
